...
<div class="wrap">
	...
	<div id="tabs-3" class="metabox-holder">
		...
		<div class="inside">
		    ...
		    <form method="post">
			<p><input type="hidden" name="v_action" value="export_settings" /></p>
			<p>
			    <?php wp_nonce_field( 'v_export_nonce', 'v_export_nonce' ); ?>
		...
		<div class="inside">
			...
			<p>
			    <input type="file" name="v_import_file"/>
			</p>
			<p>
			    <input type="hidden" name="v_action" value="import_settings" />
			    <?php wp_nonce_field( 'v_import_nonce', 'v_import_nonce' ); ?>
	...
	<div class="postbox">
	    <h3 class="hndle"><span><?php _e( 'viper', $this->plugin_slug ); ?></span></h3>
	    <div class="inside">
		<a href="https://github.com/Mte90/WordPress-Plugin-Boilerplate-Powered"><img src="https://github.com/Mte90/WordPress-Plugin-Boilerplate-Powered/raw/master/viper/assets/icon-256x256.png" alt=""></a>
	    </div>
	</div>
    </div>
</div>
