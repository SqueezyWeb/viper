<?php
    ...
    class FS_Api
    {
         ...
         * @return FS_Api
         */
        public static function instance($slug, $scope, $id, $public_key, $is_sandbox, $secret_key = false)
        {
            ...
            if (!isset(self::$_instances[ $identifier ])) {
                ...
                self::$_instances[ $identifier ] = new self($slug, $scope, $id, $public_key, $secret_key, $is_sandbox);
            }
