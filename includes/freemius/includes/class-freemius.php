...
------------------------------------------------------------------------------------------------------------------*/
         ...
         */
        public function _data_migration($sdk_prev_version, $sdk_version)
        {
            /*
         ...
         * @return false|Freemius
         */
        public static function get_instance_by_file($plugin_file)
        {
         ...
         */
        public function get_addon_instance($slug_or_id)
        {
            return !is_numeric($slug_or_id) ?
         ...
         * @return bool
         */
        public function is_parent_plugin_installed()
        {
         ...
         * @return bool
         */
        public function is_parent_in_activation()
        {
...
//			add_filter( 'auto_update_plugin', '_include_plugins_in_auto_update', 10, 2 );
         ...
         * @since  1.1.7.3
         */
        public static function _toggle_debug_mode()
        {
...
//			$licenses = self::get_all_licenses();
         ...
         * @return bool
         */
        public function has_api_connectivity($flush_if_no_connectivity = false)
        {
         ...
         * @return \WP_User
         */
        public static function _get_current_wp_user()
        {
         ...
         */
        public function _add_connectivity_issue_message($api_result, $is_first_failure = true)
        {
...
//						break;
         ...
         * @since  1.0.9
         */
        public function _email_about_firewall_issue()
        {
         ...
         * @since  1.1.7.4
         */
        public function _retry_connectivity_test()
        {
        ...
        public static function _add_firewall_issues_javascript()
        {
            $params = array();
         ...
         */
        public function init($id, $public_key, $is_live = true, $is_premium = true)
        {
            $this->_logger->entrance();
...
//				'secret_key' => $secret_key,
         ...
         * @since  1.0.9
         */
        public function _plugin_code_type_changed()
        {
...
//			$this->sync_install();
         ...
         * @return bool
         */
        public function is_addon_activated($slug_or_id)
        {
         ...
         * @return bool
         */
        public function is_addon_connected($slug)
        {
            $sites = self::get_all_sites();
         ...
         * @return string
         */
        public function get_addon_basename($slug)
        {
         ...
         */
        public function init_addon($parent_plugin_id)
        {
         ...
         */
        public function init_sandbox($secret_key)
        {
            $this->_plugin->secret_key = $secret_key;
         ...
         * @return bool
         */
        public function is_payments_sandbox()
        {
         ...
         * @return bool
         */
        public function is_org_repo_compliant()
        {
         ...
         * @return int|false
         */
        public function next_sync_cron()
        {
            $this->_logger->entrance();
         ...
         * @return int|false
         */
        public function last_sync_cron()
        {
            $this->_logger->entrance();
         ...
         * @return int|false
         */
        public function last_install_sync()
        {
            $this->_logger->entrance();
         ...
         * @return int|false
         */
        public function next_install_sync()
        {
            $this->_logger->entrance();
         ...
         */
        public function _add_pending_activation_notice($email = false)
        {
            if (!is_string($email)) {
                $current_user = self::_get_current_wp_user();
         ...
         * @since  1.0.7
         */
        public function _admin_init_action()
        {
            /*
         ...
         * @since  1.1.4
         */
        public function _enqueue_connect_essentials()
        {
         ...
         * @since  1.1.4
         */
        public function _add_connect_pointer_script()
        {
         ...
         * @param bool $store
         */
        public function _delete_site($store = true)
        {
            $sites = self::get_all_sites();
         ...
         * @return bool
         */
        public function is_plugin_new_install()
        {
         ...
         * @uses   FS_Api
         */
        public function _activate_plugin_event_hook()
        {
...
//				$this->sync_install( array(), true );
         ...
         */
        public function delete_account_event($check_user = true)
        {
            $this->_logger->entrance('slug = '.$this->_slug);
         ...
         * @since  1.0.1
         */
        public function _deactivate_plugin_hook()
        {
            $this->_logger->entrance('slug = '.$this->_slug);
...
//			$this->sync_install( array(), true );
        ...
        private function get_plugins_data_for_api()
        {
            ...
            if ($plugins_changed) {
                ...
                foreach ($all_cached_plugins->plugins as $basename => $data) {
                    ...
                    } elseif ($data['is_active'] !== $all_plugins[ $basename ]['is_active'] ||
         ...
         * @param bool $check_user Enforce checking if user have plugins activation privileges.
         */
        public function _uninstall_plugin_event($check_user = true)
        {
            $this->_logger->entrance('slug = '.$this->_slug);
         ...
         * @return FS_Plugin[]|false
         */
        public function get_account_addons()
        {
            $this->_logger->entrance();
         ...
         * @return bool
         */
        public function has_account_addons()
        {
         ...
         */
        public function get_trial_plan()
        {
            $this->_logger->entrance();
         ...
         * @return bool
         */
        public function _has_premium_license()
        {
            $this->_logger->entrance();
         ...
         * @return FS_Plugin_License
         */
        public function _get_available_premium_license()
        {
            $this->_logger->entrance();
         ...
         * @return FS_Plugin_Plan
         */
        public function _get_plan_by_id($id)
        {
            $this->_logger->entrance();
         ...
         */
        public function _sync_licenses()
        {
         ...
         * @return FS_Plugin_License
         */
        public function _get_license_by_id($id)
        {
            $this->_logger->entrance();
         ...
         */
        public function _update_site_license($new_license)
        {
            $this->_logger->entrance();
        ...
        public function is_plan($plan, $exact = false)
        {
            ...
            for ($i = 0, $len = count($this->_plans); $i < $len; ++$i) {
                ...
                } elseif ($this->_site->plan->name === $this->_plans[ $i ]->name) {
         ...
         * @return bool
         */
        public function is_trial_plan($plan, $exact = false)
        {
            $this->_logger->entrance();
            ...
            for ($i = 0, $len = count($this->_plans); $i < $len; ++$i) {
                if ($plan === $this->_plans[ $i ]->name) {
                    $required_plan_order = $i;
                } elseif ($this->_storage->trial_plan->name === $this->_plans[ $i ]->name) {
                    $current_plan_order = $i;
                }
            }
         ...
         * @return bool
         */
        public function has_trial_plan()
        {
            if (!$this->is_registered()) {
                return false;
            }
         ...
         * @return string
         */
        public function get_upgrade_url($period = WP_FS__PERIOD_ANNUALLY, $is_trial = false)
        {
         ...
         * @return string
         */
        public function pricing_url($billing_cycle = WP_FS__PERIOD_ANNUALLY, $is_trial = false)
        {
            $this->_logger->entrance();
         ...
         * @return string
         */
        public function addon_checkout_url(
            $addon_id,
            $pricing_id,
            $billing_cycle = WP_FS__PERIOD_ANNUALLY,
            $is_trial = false
         ...
         * @return bool
         */
        public function enable_anonymous()
        {
         ...
         * @throws Exception
         */
        public function is_feature_supported($feature_id)
        {
         ...
         * @return bool
         */
        public function is_ssl_and_plan($plan, $exact = false)
        {
         ...
         * @return string
         */
        public function _get_admin_page_url($page = '', $params = array())
        {
         ...
         * @return string
         */
        public function get_account_url($action = false, $params = array(), $add_action_nonce = true)
        {
            if (is_string($action)) {
         ...
         * @return string
         */
        public function contact_url($topic = false, $message = false)
        {
            $params = array();
            if (is_string($topic)) {
                $params['topic'] = $topic;
         ...
         * @return string
         */
        public function addon_url($slug)
        {
         ...
         * @return FS_Logger
         */
        public function get_logger($id = '', $prefix_slug = true)
        {
         ...
         */
        public function get_options_manager($id, $load_options = false, $prefix_slug = true)
        {
         ...
         * @since  1.0.2
         */
        public function _activate_account()
        {
            if ($this->is_registered()) {
                // Already activated.
                return;
         ...
         * @return array
         */
        public function get_opt_in_params($override_with = array())
        {
            $this->_logger->entrance();
         ...
         */
        public function opt_in($email = false, $first = false, $last = false)
        {
            $this->_logger->entrance();
         ...
         */
        public function setup_account(FS_User $user, FS_Site $site, $redirect = true)
        {
            $this->_user = $user;
            $this->_site = $site;
         ...
         * @since  1.0.7
         */
        public function _install_with_new_user()
        {
            $this->_logger->entrance();
         ...
         * @since  1.0.7
         */
        public function _install_with_current_user()
        {
            $this->_logger->entrance();
...
//				$this->_sync_plans();
         ...
         * @since  1.0.9
         */
        public function _prepare_admin_menu()
        {
            //			if ( ! $this->is_on() ) {
//				return;
//			}
         ...
         * @return string
         */
        public function _redirect_on_clicked_menu_link()
        {
            $this->_logger->entrance();
        ...
        private function override_plugin_menu_with_activation()
        {
            ...
            if (false !== $hook) {
                ...
                } elseif (fs_request_is_action($this->_slug.'_activate_new')) {
         ...
         */
        public function _add_default_submenu_items()
        {
            if (!$this->is_on()) {
                return;
            }
         ...
         * @param int    $priority
         */
        public function add_submenu_link_item(
            $menu_title,
            $url,
            $menu_slug = false,
            $capability = 'read',
         ...
         * @uses   add_action()
         */
        public function add_action($tag, $function_to_add, $priority = WP_FS__DEFAULT_PRIORITY, $accepted_args = 1)
        {
            $this->_logger->entrance($tag);
         ...
         * @uses   add_filter()
         */
        public function add_filter($tag, $function_to_add, $priority = WP_FS__DEFAULT_PRIORITY, $accepted_args = 1)
        {
            $this->_logger->entrance($tag);
         ...
         */
        public function get_update($plugin_id = false, $flush = true)
        {
            $this->_logger->entrance();
         ...
         */
        public function start_trial($plan_name = false)
        {
            $this->_logger->entrance();
         ...
         */
        public function _fetch_latest_version($addon_id = false, $flush = true)
        {
            $this->_logger->entrance();
         ...
         * @return string
         */
        public function _get_latest_download_local_url($plugin_id = false)
        {
         ...
         * @since  1.0.6
         */
        public function _account_page_load()
        {
            $this->_logger->entrance();
         ...
         * @since  1.0.7
         */
        public function _connect_page_render()
        {
            $this->_logger->entrance();
         ...
         * @since  1.0.6
         */
        public function _addons_page_load()
        {
            $this->_logger->entrance();
         ...
         * @since  1.0.0
         */
        public function _pricing_page_render()
        {
            $this->_logger->entrance();
         ...
         * @since  1.0.3
         */
        public function _contact_page_render()
        {
            $this->_logger->entrance();
        ...
        public static function _clean_admin_content_section_hook()
        {
         ...
         * @since  1.0.3
         */
        public static function _clean_admin_content_section()
        {
         ...
         * @return FS_Api
         */
        public function get_api_user_scope($flush = false)
        {
         ...
         * @return FS_Api
         */
        public function get_api_site_scope($flush = false)
        {
         ...
         * @return FS_Api
         */
        public function get_api_plugin_scope()
        {
         ...
         * @return FS_Api
         */
        public function get_api_site_or_plugin_scope()
        {
         ...
         * @param $plans
         */
        public function _check_for_trial_plans($plans)
        {
         ...
         * @since  1.0.9
         */
        public function _add_trial_notice()
        {
            // Check if trial already utilized.
            if ($this->_site->is_trial_utilized()) {
                return;
         ...
         * @param bool $key
         */
        public function add_plugin_action_link($label, $url, $external = false, $priority = WP_FS__DEFAULT_PRIORITY, $key = false)
        {
            $this->_logger->entrance();
         ...
         * @since  1.0.0
         */
        public function _add_upgrade_action_link()
        {
            $this->_logger->entrance();
         ...
         * @return string
         */
        public function get_after_plugin_activation_redirect_url()
        {
            $url = false;
            $plugin_fs = false;
         ...
         * @since  1.0.3
         */
        public function _redirect_on_activation_hook()
        {
         ...
         * @return array
         */
        public function _modify_plugin_action_links_hook($links, $file)
        {
            $this->_logger->entrance();
         ...
         * @param string $type
         */
        public function add_admin_message($message, $title = '', $type = 'success')
        {
         ...
         * @param string $type
         */
        public function add_sticky_admin_message($message, $id, $title = '', $type = 'success')
        {
         ...
         * @return bool
         */
        public static function _include_plugins_in_auto_update($update, $item)
        {
         ...
         * @return bool
         */
        public function is_sdk_upgrade_mode()
        {
         ...
         * @return bool
         */
        public function set_sdk_upgrade_complete()
        {
            $this->_storage->sdk_upgrade_mode = false;
        }
         ...
         * @return bool
         */
        public function is_plugin_upgrade_mode()
        {
         ...
         * @return bool
         */
        public function set_plugin_upgrade_complete()
        {
            $this->_storage->plugin_upgrade_mode = false;
        }
         ...
         * @return bool
         */
        public function is_permission_requested($permission)
        {
         ...
         * @return bool
         */
        public function has_purchased_before()
        {
