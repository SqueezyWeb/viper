<?php
    ...
    class FS_Admin_Notice_Manager
    {
         ...
         */
        public static function instance($slug, $title = '')
        {
            if (!isset(self::$_instances[ $slug ])) {
                self::$_instances[ $slug ] = new self($slug, $title);
            }
         ...
         * @since  1.0.4
         */
        public function _all_admin_notices_hook()
        {
         ...
         * @uses   add_action()
         */
        public function add($message, $title = '', $type = 'success', $is_sticky = false, $all_admin = false, $id = '', $store_if_sticky = true)
        {
         ...
         * @param bool   $all_admin
         */
        public function add_sticky($message, $id, $title = '', $type = 'success', $all_admin = false)
        {
